...
export const HealthIndicatorRealSystemChart: React.FC = ({totalLogsSamples, totalLogsAnomalies, height}) => {
    ...
    series: [
      {
        ...
        data: [
          {
            value: totalLogsAnomalies > 0 ? totalLogsAnomalies / totalLogsSamples : 0,
          }
        ]
      }
    ]
  ...
  return (
    <BaseChart option={option} height={height} width={"100%"}/>
  )
